...
ImputLanguage = "en"  # Default language, can be changed as needed
...
HtmlCode = HtmlCode.replace("recognition.lang = '';", f"recognition.lang = '{"en"}';")
    ...
    while True:
        try:
            ...
            if Text:
                ...
                if "en".lower() == "en" or "en" in "en".lower():
